...
- **Prod Hosting:** **`hsm-dashboard`** — **`https://hsm-dashboard.web.app`**; `/api` → **`api-prod`**. Deployed when you **publish a GitHub Release** (same tag as backend prod), not on every merge to `main`.
